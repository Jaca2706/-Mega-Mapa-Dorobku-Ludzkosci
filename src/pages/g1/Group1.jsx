...
const okresy = [
  ...
  { id: "dwudziestolecie-miedzywojenne", nazwa: "Dwudziestolecie międzywojenne", kolor: "#3B82F6", start: 1918, koniec: 1939, image: "https://th.bing.com/th/id/R.9e842d263ea928be77bae72af0696831?rik=gfttBP%2bUbO9Pyw&riu=http%3a%2f%2flicealista.pl%2fwp-content%2fuploads%2f2016%2f02%2fdwudziestolecie-miedzywojenne.jpg&ehk=AoWgjjxisLcOFiGj%2bSVaLi6DEnE3fqFx1SMzokSGUf0%3d&risl=&pid=ImgRaw&r=0" },
  { id: "wojna-i-okupacja", nazwa: "Wojna i okupacja", kolor: "#1F2937", start: 1939, koniec: 1945, image: "https://aniakubica.com/wp-content/uploads/2021/03/wojna-i-okupacja-prezentacja.jpeg" },
...
// Funkcja do pobierania wydarzeń dla epoki
          ...
          return (
            ...
            >
              ...
              <div className="panel-content">
                  ...
                  {selectedPeriod.image && (
                    <div className="panel-image-container">
                      <img 
                        ...
                        className={`epoch-image ${selectedPeriod.id === "sredniowiecze" ? "original-size" : ""}`}
                      />
                    </div>
                  )}
                </div>
                  ...
                  <div className="epoka-description-container">
                    ...
                    {Array.isArray(opisEpoki)
                      ? opisEpoki.map((linia, index) => (
                          <p key={index} className="epoka-description">{linia}</p>
                        ))
                ...
                {/* CIEKAWOSTKI */}
                {ciekawostki && ciekawostki.length > 0 && (
                  <div className="epoka-ciekawostki">
                    <h4>💡 Ciekawostki:</h4>
                    <ul className="ciekawostki-list">
                ...
                <div className="wydarzenia-section">
                  <h4>📚 Dzieła literackie:</h4>
                  <ul className="timeline-events-list">
                    {wydarzenia.length > 0 ? (
                      wydarzenia.map((item) => (
                        ...
                        >
                          <div className="event-header">
                            ...
                            {item.author && <span className="event-author"> – {item.author}</span>}
                            {item.year && <span className="event-year"> ({formatYear(item.year)})</span>}
                          </div>
                      ...
                      <li className="no-events">📖 Brak dzieł dla tej epoki w bazie</li>
                    )}
                  </ul>
                </div>
              </div>
